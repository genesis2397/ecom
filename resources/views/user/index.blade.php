        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        ...
                        @foreach($cat->subcategories as $subcat)
                          <div class="col-sm-12 col-md-3">
                            <ul class="links list-unstyled">
                                <li><a href="#"><h2>{{ $subcat->subcategory_name_en }}</h2></a></li>
                              @php
                                $subsubcategory = App\Models\SubSubCategory::where('subcategory_id',$subcat->id)->orderBy('subsubcategory_name_en','ASC')->get();
                              @endphp
                                  @forelse($subsubcategory as $subsubcategories)
                                    <li><a href="#">{{ $subsubcategories->subsubcategory_name_en }}</a></li>
                                  @empty
                                    <li class="text-danger">N/A</li>
                                  @endforelse
                            </ul>
                          </div>
                        @endforeach
          ...
          <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
            ...
            <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
              @foreach ($hot_deals as $hotdeals)
              <div class="item">
                <div class="products">
                  <div class="hot-deal-wrapper">
                    <div class="image"> <img src="{{ asset($hotdeals->product_thambnail) }}" alt=""> </div>
                    @php
                        $amount = $hotdeals->selling_price - $hotdeals->getRawOriginal('discount_price');
                        $percent = ($amount/$hotdeals->selling_price)*100;
                    @endphp
                    <div class="sale-offer-tag"><span>{{ round($percent,2) }}%<br>
                      off</span></div>
                  ...
                  <div class="product-info text-left m-t-20">
                    <h3 class="name"><a href="detail.html">{{ $hotdeals->product_name_en }}</a></h3>
                    <div class="rating rateit-small"></div>
                    <div class="product-price"> <span class="price">{{ money($hotdeals->getRawOriginal('discount_price'),'PHP',true) }}</span> <span class="price-before-discount">{{ money($hotdeals->selling_price,'PHP',true) }}</span> </div>
          ...
          <div class="sidebar-widget outer-bottom-small wow fadeInUp">
            ...
            <div class="sidebar-widget-body outer-top-xs">
              <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                @foreach ($special_offer->chunk(3) as $offer)
                <div class="item">
                  <div class="products special-product">
                      @foreach ($offer as $special)
                      <div class="product">
                        <div class="product-micro">
                          <div class="row product-micro-row">
                            <div class="col col-xs-5">
                              <div class="product-image">
                                <div class="image"> <a href="#"> <img src="{{ asset($special->product_thambnail) }}" alt=""> </a> </div>
                                <!-- /.image -->
                            ...
                            <div class="col col-xs-7">
                              <div class="product-info">
                                <h3 class="name" title="{{ $special->product_name_en }}"><a href="#">{{ mb_strimwidth($special->product_name_en, 0, 16, "..") }}</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="product-price"> <span class="price">{{ money($special->selling_price,'PHP',true) }}</span> </div>
                                <!-- /.product-price -->
            ...
            <div class="sidebar-widget-body outer-top-xs">
              <div class="tag-list">
                  @foreach ($slice as $key => $cout)
                    <a class="item" title="Vest" href="{{ route('popular.tags',$key) }}">{{ ucwords($key)." ($cout)" }}</a>
                  @endforeach
                </div>
              <!-- /.tag-list -->
            </div>
                  ...
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    <div class="item item-carousel">
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            <div class="image"> <a href="{{ route('view.detail',$product->id) }}"><img  src="{{ asset($product->product_thambnail) }}" alt=""></a> </div>
                            <!-- /.image -->
                             @if ($product->getRawOriginal('discount_price') == null || $product->getRawOriginal('discount_price') == '0')
                                <div class="tag new"><span>new</span></div>
                                <div class="product-info text-left">
                                    <h3 class="name"><a href="{{ route('view.detail',$product->id) }}">{{ $product->product_name_en }}</a></h3>
                                    <div class="rating rateit-small"></div>
                             ...
                             @endphp
                               ...
                               <div class="tag hot"><span>-{{ round($discount,2) }}%</span></div>
                                <div class="product-info text-left">
              ...
              <div class="tab-pane" id="category{{ $cat->id }}">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                    ...
                    @php
                        $products = App\Models\Product::whereCategoryId($cat->id)->where('status',1)->latest()->take(6)->get();
                    @endphp
                    ...
                    @empty
                        <h4 class="text-danger">No Product</h4>
                    @endforelse
                    <!-- /.item -->
                  </div>
                  <!-- /.home-owl-carousel -->

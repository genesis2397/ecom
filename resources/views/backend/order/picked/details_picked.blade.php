...
<table class="table">
            ...
            <tr>
              <th> Order : </th>
               <th>
                <span class="badge badge-pill badge-warning" style="background: #a8c218;">{{ $order->status }} <i class="fa fa-handshake-o"></i></span> </th>
            </tr>

            <tr>
                <th> Update Status : </th>
                 <th><a href="{{ route('update.picked',$order->id) }}" class="btn btn-success" id="shippedOrder">Ship the Order</a></th>
              </tr>

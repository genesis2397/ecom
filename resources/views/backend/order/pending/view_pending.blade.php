                         ...
                         <tbody>
                            @foreach ($order as $orders)
                                <tr>
                                    ...
                                    <td><span class="label label-warning" style="border-radius: 15px;">{{  $orders->status }} <i class="fa fa-clock-o"></i></span></td>
                                    <td>
                                        <a class="btn btn-primary" title="View Pending Order" href="{{ route('details.pending',$orders->id) }}"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                         </tbody>

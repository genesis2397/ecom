                         ...
                         <tbody>
                            @foreach ($order as $orders)
                                <tr>
                                    ...
                                    <td><span class="label label-success" style="border-radius: 15px;">Shipped  <i class="mdi mdi-truck-delivery"></i></span></td>
                                    <td>
                                        <a class="btn btn-primary" title="View Shipped Order" href="{{ route('details.shipped',$orders->id) }}"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                         </tbody>

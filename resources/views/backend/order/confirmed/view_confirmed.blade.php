                         ...
                         <tbody>
                            @foreach ($order as $orders)
                                <tr>
                                    ...
                                    <td><span class="label label-success" style="border-radius: 15px;">{{  $orders->status }} <i class="fa fa-check"></i></span></td>
                                    <td>
                                        <a class="btn btn-primary" title="View Confirmed Order" href="{{ route('details.confirmed', $orders->id) }}"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                         </tbody>
